      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-4">
            <span className="text-cyber-500">&lt;</span>Entre em contato <span className="text-cyber-500">/&gt;</span>
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
          Tem alguma dúvida ou quer trabalhar junto? Fique à vontade para entrar em contato comigo usando o formulário abaixo.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-6">
              <span className="text-cyber-500">&gt;</span> Informações de Contato
            </h2>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Disponível de segunda a sexta, das 9h às 17h</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <motion.a
                href="https://github.com/suclouflare"
                target="_blank"
          ...
          >
            <div className="card p-6 cyber-border">
              <h2 className="text-2xl font-bold text-white mb-6">
                <span className="text-cyber-500">&gt;</span> Envie-me uma Mensagem
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg bg-dark-600 text-white border border-dark-400 focus:outline-none focus:ring-2 focus:ring-cyber-500 focus:border-transparent"
                    placeholder="Consulta sobre o projeto"
                  />
                </div>
